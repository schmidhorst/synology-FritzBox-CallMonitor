#!/bin/bash
# Filename: environ.cgi - coded in utf-8
#
#        from DSM7DemoSPK
...
# --------------------------------------------------------------
  ...
  display_name="Tool to monitor phone calls via FritzBox on DSM 7" # used as title of Page 
      ...
      <article>'
        ...
        if [[ "${is_admin}" == "yes" ]]; then
          ...
          <span style="font-family: Consolas,monospace; font-size: 0.8em;">'
            ...
            echo "The account $user belongs to the groups"
            grp=$(grep "$user" < "/etc/group")
...
#          <br />'
        ...
        echo "<p><button onclick=\"location.href='systeminfo.cgis'\" type=\"button\">System Info</button></p>"
        echo '
      </article>
    </body>
  </html>'
